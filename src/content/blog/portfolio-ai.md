...
## Fuzzy Brain basics
<img src='/public/assets/portfolio-ai/signalStruct.png' class='w-80% self-align-center'> </img>
...
<div class="flex flex-col lg:flex-row items-center lg:space-x-4 space-y-4 lg:space-y-0 p-4">
    <div class="w-full lg:w-2/3">
        <img src="/public/assets/portfolio-ai/severityThresholds.png" class="rounded-lg" />
    </div>
...
<img src="/public/assets/portfolio-ai/signalThresholdBT.png" class="rounded-lg p-4" />


<div class="flex flex-col lg:flex-row items-center lg:space-x-4 space-y-4 lg:space-y-0 p-4">
    <div class="w-full lg:w-2/3">
        <img src="/public/assets/portfolio-ai/signalPriority.gif" class="rounded-lg" />
    </div>
    <div class="w-full lg:w-1/3">
...
## Hearing
<img src='/public/assets/portfolio-ai/hearingThrowable.gif' class='hidden'></img>
...
<div class="flex flex-col lg:flex-row items-center lg:space-x-4 space-y-4 lg:space-y-0 p-4">
    <div class="w-full lg:w-2/3">
        <img src="/public/assets/portfolio-ai/hearingDiagram.png" class="rounded-lg" />
    </div>
    <div class="w-full lg:w-1/3">
...
<div class="flex flex-col lg:flex-row items-center lg:space-x-4 space-y-4 lg:space-y-0 p-4">
    <div class="w-full lg:w-1/2 flex flex-col space-y-4">
        <img src="/public/assets/portfolio-ai/noiseDataAsset.png" class="rounded-lg" />
    </div>
   ...
   <div class="w-full lg:w-1/2 flex flex-col space-y-4 p-4">
        ...
        <div>
            <img src="/public/assets/portfolio-ai/hearingThrowable.gif" class="rounded-lg" />
        </div>
    </div>
</div>
...
## Sight
<img src='/public/assets/portfolio-ai/sightDemo2.gif' class='rounded-lg p-4' ></img>
...
<div class="flex flex-col lg:flex-row items-center lg:space-x-4 space-y-4 lg:space-y-0 p-4">
    <div class="w-full lg:w-1/2 flex flex-col space-y-4">
        <img src="/public/assets/portfolio-ai/sightBP.png" class="rounded-lg" />
    </div>
   ...
   <div class="w-full lg:w-1/2 flex flex-col space-y-4 p-4">
        ...
        <div>
            <img src="/public/assets/portfolio-ai/sightParams.png" class="rounded-lg" />
        </div>
    </div>
</div>
...
## Waypoint system
<img src="/public/assets/portfolio-ai/Waypoints.gif" class="hidden" />
...
<div class="flex flex-col lg:flex-row items-center lg:space-x-4 space-y-4 lg:space-y-0 p-4">
    <div class="w-full lg:w-2/3">
        <img src="/public/assets/portfolio-ai/Waypoints.gif" class="rounded-lg" />
    </div>
    <div class="w-full lg:w-1/3">
...
<div class="flex flex-col lg:flex-row items-center lg:space-x-4 space-y-4 lg:space-y-0 p-4">
    <div class="w-full lg:w-1/2 flex flex-col space-y-4">
        <img src="/public/assets/portfolio-ai/waypointsIngame.gif" class="rounded-lg" />
        <p class="text-justify">
   ...
   <div class="w-full lg:w-1/2 flex flex-col space-y-4 p-4">
        ...
        <div>
            <img src="/public/assets/portfolio-ai/waypointBT.png" class="rounded-lg" />
        </div>
    </div>
</div>
